package que11_sum_calculator;

/* 11. Write a class with the name SimpleCalculator. The class needs two fields(instance variables) with names firstNumber
...
public class SimpleCalculator {
    ...
    public static void main(String[] args){
        ...
        calculator.setFirsNumber(5.0);
        calculator.setSecondNumber(4);
        System.out.println("add= " + calculator.getAdditionResult());
        System.out.println("subtract= " + calculator.getSubtractionResult());
        calculator.setFirsNumber(5.25);
