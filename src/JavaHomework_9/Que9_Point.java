...
/* 9. You have to represent a point in 2D space. Write a class with the name Point. The class needs two fields
...
To find a distance between points A(xA,yA) and B(xB,yB),
...
public class Que9_Point {
    ...
    public double distance(Que9_Point another) {
        return distance(another.x, another.y);
    }

    public static void main(String[] args) {
        Que9_Point first = new Que9_Point(6, 5);
        Que9_Point second = new Que9_Point(3, 1);

        System.out.println("distance(0,0)= " + first.distance());
        System.out.println("distance(second)= " + first.distance(second));
        System.out.println("distance(2,2)= " + first.distance(2, 2));

        Que9_Point point = new Que9_Point();
